...
if(isset($_REQUEST['psubmit'])){
 ...
 if(($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginalcost'] == "") || ($_REQUEST['psellingcost'] == "")){
  ...
  $msg = '<div class="alert alert-dark col-sm-12 ml-1 text-center mt-2" role="alert"> Fill All Fileds </div>';
 } else {
  ...
  $psellingcost = $_REQUEST['psellingcost'];
   ...
   if($conn->query($sql) == TRUE){
    ...
    $msg = '<div class="alert alert-dark col-sm-12 ml-1 text-center mt-2" role="alert"> Added Successfully </div>';
   } else {
    // below msg display on form submit failed
    $msg = '<div class="alert alert-dark col-sm-12 ml-1 text-center mt-2" role="alert"> Unable to Add </div>';
   }
 }
 }
?>
