...
if(isset($_SESSION['is_adminlogin'])){
 ...
 if(isset($_REQUEST['assign'])){
  ...
  if(($_REQUEST['request_id'] == "") || ($_REQUEST['request_info'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['address1'] == "") || ($_REQUEST['address2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "") || ($_REQUEST['assigntech'] == "") || ($_REQUEST['inputdate'] == "")){
   ...
   $msg = '<div class="alert alert-warning col-sm-12 ml-1 text-center mt-2" role="alert"> Fill All Fileds </div>';
  } else {
    ...
    if($conn->query($sql) == TRUE){
     ...
     $msg = '<div class="alert alert-success col-sm-12 ml-1 text-center mt-2" role="alert"> Work Assigned Successfully </div>';
    } else {
     // below msg display on form submit failed
     $msg = '<div class="alert alert-danger col-sm-12 ml-1 text-center mt-2" role="alert"> Unable to Assign Work </div>';
    }
  }
  }
