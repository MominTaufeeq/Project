...
session_start();
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  if(($_REQUEST['r_login_id'] == "") || ($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "")){
   ...
   $msg = '<div class="alert alert-warning col-sm-12 ml-1 mt-2" role="alert"> Fill All Fileds </div>';
  } else {
  ...
  $sql = "UPDATE requesterlogin_tb SET r_login_id = '$rid', r_name = '$rname', r_email = '$remail' WHERE r_login_id = '$rid'";
    if($conn->query($sql) == TRUE){
     ...
     $msg = '<div class="alert alert-success col-sm-12 ml-1 mt-2" role="alert"> Updated Successfully </div>';
    } else {
     // below msg display on form submit failed
     $msg = '<div class="alert alert-danger col-sm-12 ml-1 mt-2" role="alert"> Unable to Update </div>';
    }
  }
  }
 ?>
 ...
 ?>
  ...
  <?php if(isset($msg)) {echo $msg; } ?>
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-dark" id="requpdate" name="requpdate">Update</button>
