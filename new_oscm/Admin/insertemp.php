 ...
 if(($_REQUEST['empName'] == "") || ($_REQUEST['empCity'] == "") || ($_REQUEST['empMobile'] == "") || ($_REQUEST['empEmail'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-12 ml-1 text-center  mt-2" role="alert"> Fill All Fileds </div>';
   ...
   if($conn->query($sql) == TRUE){
    ...
    $msg = '<div class="alert alert-success col-sm-12 ml-1 text-center mt-2" role="alert"> Added Successfully </div>';
   } else {
  // below msg display on form submit failed
    $msg = '<div class="alert alert-danger col-sm-12 ml-1 text-center mt-2" role="alert"> Unable to Add </div>';
   }
 }
 }
?>
