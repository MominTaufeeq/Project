...
if(isset($_REQUEST['reqsubmit'])){
 ...
 if(($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "") || ($_REQUEST['r_password'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-12 ml-2 mt-2 text-center" role="alert"> Fill All Fileds </div>';
 } else {
   ...
   if($conn->query($sql) == TRUE){
    ...
    $msg = '<div class="alert alert-success col-sm-12 ml-2 mt-2" role="alert text-center"> Added Successfully </div>';
   } else {
    // below msg display on form submit failed
    $msg = '<div class="alert alert-danger col-sm-12 ml-2 mt-2" role="alert"> Unable to Add </div>';
   }
 }
 }
?>
