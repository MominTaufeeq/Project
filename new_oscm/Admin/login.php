...
if(!isset($_SESSION['is_adminlogin'])){
  if(isset($_REQUEST['aEmail'])){
    ...
    if($result->num_rows == 1){
      ...
      $msg = '<div class="alert alert-dark mt-2 text-center" role="alert"> Enter Valid Email and Password </div>';
    }
  }
} else {
  echo "<script> location.href='dashboard.php'; </script>";
...
<body>
  ...
  <p class="text-center mt-5" style="font-size: 30px;"> <span>Admin
      Login</span>
  </p>
  <div class="container-fluid mb-5">
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-5 col-md-5">
        ...
        <div class="text-center"><a class="btn btn-dark mt-3 shadow-sm font-weight-bold" href="../index.php">Back
            to Home</a></div>
      </div>
    </div>
  </div>
