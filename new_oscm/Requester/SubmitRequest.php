...
if(isset($_REQUEST['submitrequest'])){
 ...
 if(($_REQUEST['requestinfo'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['requesteradd1'] == "") || ($_REQUEST['requesteradd2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "")){
  // || ($_REQUEST['requestdate'] == "")
  // msg displayed if required field missing
  $msg = '<div class="alert alert-dark col-sm-12 text-center ml-1 mt-2" role="alert"> Fill All Fileds </div>';
 } else {
   ...
   if($conn->query($sql) == TRUE){
    ...
    $msg = '<div class="alert alert-dark col-sm-6 ml-5 mt-2" role="alert"> Request Submitted Successfully Your' . $genid .' </div>';
    session_start();
    $_SESSION['myid'] = $genid;
...
<div class="col-sm-9 col-md-10 mt-5">
  ...
  <?php if(isset($msg)) {echo $msg; } ?>
    <div class="form-group">
      ...
      <select class="form-control" id="inputRequestInfo" placeholder="Request Info" name="requestinfo">
      <option>Select your option</option>
      <option value="Refregerator">Refregerator</option>
  <option value="Solar panel">Solar panel</option>
  <option value="TV repair">TV repair</option>
  <option value="Filter repair">Filter repair</option>
  <option value="Washing Machine">Washing Machine</option>
  <option value="Air Conditioner">Air Conditioner</option>
  <option value="Inverter Repair">Inverter Repair</option>
  <option value="Oven Machine">Oven Machine</option>
  <option value="Water Motor Repair">Water Motor Repair</option>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input class="form-control" id="inputDate" name="requestdate" placeholder="<?php
