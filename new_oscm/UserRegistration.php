    ...
    <div class="form-container col-md-6 offset-md-3">
      ...
      <?php 
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control" placeholder="Email" name="rEmail" pattern="^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$" required>
        ...
        <center><button type="submit" class="btn btn-dark mt-5 btn-block shadow-sm font-weight-bold" name="rSignup">Sign Up</button></center>
        <em style="font-size:10px;">Note - By clicking Sign Up, you agree to our Terms, Data
          ...
          <div class="d-grid mt-0">
                        <p>Already have an account?<a href="Requester\RequesterLogin.php">Login</a></p>
                  </div>
